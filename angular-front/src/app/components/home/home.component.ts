...
import { AnouncementItemComponent } from '../anouncement-item/anouncement-item.component';
...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [RouterLink, AnouncementItemComponent, CommonModule],
  templateUrl: './home.component.html',
  styleUrl: './home.component.css'
})
export class HomeComponent {
intro: string = "PAGE D'ACCUEIL";
presentation: string = "Bienvenue sur electricity-Business";
